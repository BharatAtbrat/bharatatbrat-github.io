jQuery(document).ready(function () {
    ...
    var grid = jQuery('.grid').imagesLoaded(function () {
        ...
        //Fix for load_anim.gif item text
        jQuery('.load_anim.gif-text-holder').each(function () {
            jQuery(this).find('p').css('margin-top', jQuery(this).height() / 2);
        });

        //Fix for load_anim.gif hover text fade in/out
        jQuery('.grid-item a').hover(function () {
            jQuery(this).find('.load_anim.gif-text-holder').fadeIn('fast');
        }, function () {
            jQuery(this).find('.load_anim.gif-text-holder').fadeOut('fast');
        });
    });
